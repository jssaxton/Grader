...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gradeapp_assignment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gradeapp.user_info'])),
            ('to_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gradeapp.MyClass'])),
            ('max_score', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('real_score', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('retry_limit', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10)),
            ('already_uploaded', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('already_graded', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('gradeapp', ['Assignment'])


    def backwards(self, orm):
        # Deleting model 'Assignment'
        db.delete_table('gradeapp_assignment')
