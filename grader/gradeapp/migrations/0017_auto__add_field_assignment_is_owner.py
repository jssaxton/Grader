...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.is_owner'
        db.add_column('gradeapp_assignment', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.is_owner'
        db.delete_column('gradeapp_assignment', 'is_owner')
