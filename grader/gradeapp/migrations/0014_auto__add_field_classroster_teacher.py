...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassRoster.teacher'
        db.add_column('gradeapp_classroster', 'teacher',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassRoster.teacher'
        db.delete_column('gradeapp_classroster', 'teacher')
