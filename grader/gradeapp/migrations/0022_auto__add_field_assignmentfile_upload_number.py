...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentFile.upload_number'
        db.add_column('gradeapp_assignmentfile', 'upload_number',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentFile.upload_number'
        db.delete_column('gradeapp_assignmentfile', 'upload_number')
    ...
    models = {
        ...
        'gradeapp.assignmentfile': {
            ...
            'file_comment': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'upload_number': ('django.db.models.fields.IntegerField', [], {'max_length': '10'})
        },
        'gradeapp.authuser': {
